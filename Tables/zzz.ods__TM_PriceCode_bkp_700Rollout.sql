...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Inser__160F4887] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Updat__17036CC0] DEFAULT (getdate()),
