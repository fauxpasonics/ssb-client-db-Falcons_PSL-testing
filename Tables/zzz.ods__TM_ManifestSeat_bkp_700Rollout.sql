...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Inser__66603565] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Updat__6754599E] DEFAULT (getdate()),
