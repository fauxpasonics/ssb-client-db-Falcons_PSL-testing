...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Tex__InsertDa__40F9A68C] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Tex__UpdateDa__41EDCAC5] DEFAULT (getdate()),
