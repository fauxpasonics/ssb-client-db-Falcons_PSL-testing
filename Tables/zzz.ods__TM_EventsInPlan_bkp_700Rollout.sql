...
[season_id] [int] NULL,
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Events__Inser__34C8D9D1] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Events__Updat__35BCFE0A] DEFAULT (getdate()),
