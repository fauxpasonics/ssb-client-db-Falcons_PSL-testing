...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Solici__Inser__3C34F16F] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Solici__Updat__3D2915A8] DEFAULT (getdate()),
