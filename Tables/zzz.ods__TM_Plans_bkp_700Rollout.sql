...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Insert__0F624AF8] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Update__10566F31] DEFAULT (getdate()),
