...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Arena__Insert__7E37BEF6] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Arena__Update__7F2BE32F] DEFAULT (getdate()),
