...
[EventDate] [datetime] NOT NULL CONSTRAINT [DF__EventLog__EventD__173876EA] DEFAULT (getdate()),
[ExecutionId] [uniqueidentifier] NOT NULL CONSTRAINT [DF__EventLog__Execut__182C9B23] DEFAULT (newid()),
