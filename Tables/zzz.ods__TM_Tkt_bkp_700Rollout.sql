...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Tkt__InsertDa__1CBC4616] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Tkt__UpdateDa__1DB06A4F] DEFAULT (getdate()),
