...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Journa__Inser__5070F446] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Journa__Updat__5165187F] DEFAULT (getdate()),
