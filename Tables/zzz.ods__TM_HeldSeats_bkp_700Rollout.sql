...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_HeldSe__Inser__4222D4EF] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_HeldSe__Updat__4316F928] DEFAULT (getdate()),
