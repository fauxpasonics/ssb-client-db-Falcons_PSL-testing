...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_PromoC__Inser__2180FB33] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_PromoC__Updat__22751F6C] DEFAULT (getdate()),
