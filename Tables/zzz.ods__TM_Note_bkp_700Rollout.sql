...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Note__InsertD__6EF57B66] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Note__UpdateD__6FE99F9F] DEFAULT (getdate()),
