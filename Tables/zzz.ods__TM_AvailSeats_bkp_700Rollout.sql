...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_AvailS__Inser__117F9D94] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_AvailS__Updat__1273C1CD] DEFAULT (getdate()),
